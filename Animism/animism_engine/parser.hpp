...
namespace animism_engine {
    ...
    public:
         ...
         *     {
         *         animism_engine::schema schema(record);
    ...
    bool parser::try_parse(const std::wstring &name, T &out)
    {
        ...
        // in release builds.
        catch (const animism_engine::type_mismatch_assert&) {
            throw;
        }
#endif // NDEBUG
    ...
    T parser::parse(const std::wstring &name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<T>(name, propInfo);
    ...
    inline bool parser::parse<bool>(const std::wstring& name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<bool>(name, propInfo);
    ...
    inline std::wstring parser::parse<std::wstring>(const std::wstring &name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<std::wstring>(name, propInfo);
    ...
    inline std::string parser::parse<std::string>(const std::wstring &name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<std::string>(name, propInfo);
    ...
    inline const counted_string* parser::parse<const counted_string*>(const std::wstring &name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<const counted_string*>(name, propInfo);
        ...
        const std::wstring &name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<ip_address>(name, propInfo);
        ...
        const std::wstring &name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<socket_address>(name, propInfo);
        ...
        const std::wstring& name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<sid>(name, propInfo);
    ...
    inline pointer parser::parse<pointer>(const std::wstring& name)
    {
        ...
        animism_engine::debug::assert_valid_assignment<pointer>(name, propInfo);
