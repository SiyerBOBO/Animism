...
namespace animism_engine { namespace testing { namespace details {
     ...
     */
     ...
     template <>
     struct tdh_morphism<animism_engine::guid> {
        static const _TDH_IN_TYPE value = TDH_INTYPE_GUID;
     };
     ...
     template <>
     struct tdh_morphism<animism_engine::hexint32> {
        static const _TDH_IN_TYPE value = TDH_INTYPE_HEXINT32;
     };

     template <>
     struct tdh_morphism<animism_engine::hexint64> {
     ...
     template <>
     struct tdh_morphism<animism_engine::binary> {
        static const _TDH_IN_TYPE value = TDH_INTYPE_BINARY;
     };


} /* namespace details */ } /* namespace testing */ } /* namespace animism_engine */
