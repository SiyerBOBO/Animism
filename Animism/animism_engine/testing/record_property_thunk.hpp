...
namespace animism_engine { namespace testing {
    ...
    inline record_property_thunk::record_property_thunk(
        const std::wstring &property,
        const animism_engine::binary &bin)
    : name_(property)
    , bytes_(bin.bytes())
    , type_(animism_engine::testing::details::tdh_morphism<animism_engine::binary>::value)
    {
    }
        ...
        bool value)
    {
        ...
        type_ = animism_engine::testing::details::tdh_morphism<bool>::value;
    }
        ...
        const T &value)
    {
        ...
        type_  = animism_engine::testing::details::tdh_morphism<T>::value;
    }
