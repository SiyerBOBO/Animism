...
namespace animism_engine {
    ...
    public:
         ...
         *
         * <example>
         *   void on_event(const EVENT_RECORD &record, const animism_engine::trace_context &trace_context)
         *   {
         *       animism_engine::schema schema(record, trace_context.schema_locator);
         *   }
         * </example>
         */
        schema(const EVENT_RECORD &, const animism_engine::schema_locator &);
         ...
         *    {
         *        animism_engine::schema schema(record, trace_context.schema_locator);
         *        std::wstring name = animism_engine::event_name(schema);
         *    }
         * </example>
         */
         ...
         *    {
         *        animism_engine::schema schema(record, trace_context.schema_locator);
         *        std::wstring name = animism_engine::opcode_name(schema);
         *    }
         * </example>
         */
         ...
         *    {
         *        animism_engine::schema schema(record, trace_context.schema_locator);
         *        std::wstring name = animism_engine::task_name(schema);
         *    }
         * </example>
         */
         ...
         *    {
         *        animism_engine::schema schema(record, trace_context.schema_locator);
         *        DECODING_SOURCE source = animism_engine::decoding_source(schema);
         *    }
         * </example>
         */
         ...
         *    {
         *        animism_engine::schema schema(record, trace_context.schema_locator);
         *        std::wstring name = animism_engine::provider_name(schema);
         *    }
         * </example>
         */
        ...
        *    {
        *        animism_engine::schema schema(record, trace_context.schema_locator);
        *        unsigned int name = animism_engine::process_id(schema);
        *    }
        * </example>
        */
        ...
        *    {
        *        animism_engine::schema schema(record, trace_context.schema_locator);
        *        unsigned int name = animism_engine::thread_id(schema);
        *    }
        * </example>
        */
        ...
        *    {
        *        animism_engine::schema schema(record, trace_context.schema_locator);
        *        LARGE_INTEGER time = animism_engine::timestamp(schema);
        *    }
        * </example>
        */
        ...
        *    {
        *        animism_engine::schema schema(record, trace_context.schema_locator);
        *        GUID activity_id = animism_engine::activity_id(schema);
        *    }
        * </example>
        */
    ...
    inline schema::schema(const EVENT_RECORD &record, const animism_engine::schema_locator &schema_locator)
        : record_(record)
