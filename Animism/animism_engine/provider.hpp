...
namespace animism_engine {
    ...
    namespace details {
        ...
        public:
             ...
             * <example>
             *    void my_fun(const EVENT_RECORD &record, const animism_engine::trace_context &trace_context) { ... }
             *    // ...
             ...
             *
             * <example>
             *    auto fun = [&](const EVENT_RECORD &record, const animism_engine::trace_context &trace_context) {...}
             *    animism_engine::guid id(L"{A0C1853B-5C40-4B15-8766-3CF1C58F985A}");
             *    provider<> powershell(id);
             ...
             * <example>
             *   animism_engine::guid id(L"{A0C1853B-5C40-4B15-8766-3CF1C58F985A}");
             *   animism_engine::provider<> powershell(id);
             *   animism_engine::event_filter filter(animism_engine::filtering::any_event);
             *   filter.add_on_event_callback([&](const EVENT_RECORD &record, const animism_engine::trace_context &trace_context) {...});
        ...
        protected:
             ...
             * </summary>
             */
            void on_event(const EVENT_RECORD &record, const animism_engine::trace_context &context) const;
        ...
        private:
            ...
            template <typename T>
            friend class animism_engine::trace;
    ...
    public:
        ...
        * <example>
        *    animism_engine::guid id(L"Microsoft-Windows-WinINet");
        *    provider<> winINet(id);
        * </example>
        */
        ...
        *
        * <example>
        *     animism_engine::provider<> process_provider(L"Microsoft-Windows-Kernel-Process");
    ...
    public:
         ...
         * </summary>
         */
         const animism_engine::guid &id() const;
    ...
    namespace details {
        ...
        template <typename T>
        void base_provider<T>::on_event(const EVENT_RECORD &record, const animism_engine::trace_context &trace_context) const
        {
    ...
    inline const animism_engine::guid &kernel_provider::id() const
    {
        return id_;
    }
