...
namespace animism_engine { namespace details {
    ...
    struct ut {
        ...
        typedef animism_engine::provider<> provider_type;
        ...
        typedef std::map<animism_engine::guid, filter_settings> provider_filter_settings;
        /**
         * <summary>
        ...
        static const unsigned long construct_enable_flags(
            const animism_engine::trace<animism_engine::details::ut> &trace);
         ...
         * </summary>
         */
        static animism_engine::guid get_trace_guid();
    };
    ...
    {
        if (name_hint.empty()) {
            return std::to_wstring(animism_engine::guid::random_guid());
        }
    ...
    inline const unsigned long ut::construct_enable_flags(
        const animism_engine::trace<animism_engine::details::ut> &)
    {
        return 0;
    }
    ...
    inline animism_engine::guid ut::get_trace_guid()
    {
        return animism_engine::guid::random_guid();
    }
