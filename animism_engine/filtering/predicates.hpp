...
using namespace animism_engine::predicates::adapters;
using namespace animism_engine::predicates::comparers;
...
namespace animism_engine { namespace predicates {
    ...
    namespace details {
        ...
        {
            virtual bool operator()(const EVENT_RECORD&, const animism_engine::trace_context&) const = 0;
        };
        ...
        struct any_event : predicate_base {
            bool operator()(const EVENT_RECORD &, const animism_engine::trace_context &) const
            {
                return true;
            }
        };
        ...
        struct and_filter : predicate_base {
            ...
            bool operator()(const EVENT_RECORD &record, const animism_engine::trace_context &trace_context) const
            {
        ...
        */
        ...
        struct property_view_predicate : details::predicate_base
        {
            ...
            //bool operator()(const EVENT_RECORD &record, const animism_engine::trace_context &trace_context)
            bool operator()(const EVENT_RECORD& record, const animism_engine::trace_context& trace_context) const
            {
                animism_engine::schema schema(record, trace_context.schema_locator);
                animism_engine::parser parser(schema);
    ...
    struct id_is : details::predicate_base {
        ...
        bool operator()(const EVENT_RECORD &record, const animism_engine::trace_context &) const
        {
